...
window.GameStorage=(()=>{
 ...
 function parse(raw){try{const s=JSON.parse(raw);return valid(s)?s:null;}catch{return null;}}
 ...
 return {status,read,write,valid,readCheckpoint,checkpoint,replace,resetBackup};
})();
